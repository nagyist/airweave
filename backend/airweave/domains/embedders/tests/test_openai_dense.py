...
from airweave.domains.embedders.openai_dense import OpenAIDenseEmbedder
...
def _build_embedder(
    ...
    with (
        patch("airweave.domains.embedders.openai_dense.AsyncOpenAI") as mock_openai,
        patch("airweave.domains.embedders.openai_dense.tiktoken") as mock_tiktoken,
    ):
