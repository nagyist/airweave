...
|-------|------|-------------|
| document_key | str | Stable Google Docs file ID. |
| title | str | Display title of the document (without .docx extension). |
| created_timestamp | datetime | Document creation timestamp. |
| modified_timestamp | datetime | Last modification timestamp. |
...
| web_url_value | Optional[str] | Direct link to the Google Docs editor. |
