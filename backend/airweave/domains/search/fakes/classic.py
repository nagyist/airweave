"""In-memory fake for ClassicSearchServiceProtocol."""
...
from airweave.domains.search.protocols import ClassicSearchServiceProtocol
...
class FakeClassicSearchService(ClassicSearchServiceProtocol):
