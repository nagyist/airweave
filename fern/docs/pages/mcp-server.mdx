...
| `retrieval_strategy` | `"hybrid"` \| `"semantic"` \| `"keyword"` | No | `"hybrid"` | Retrieval strategy |

See the [Search documentation](/search) for details on retrieval strategies and the full search API.
