...
|-------|------|-------------|
| balance_id | str | Synthetic ID for the balance snapshot. |
| balance_name | str | Display label for this balance snapshot. |
| snapshot_time | datetime | Timestamp when the balance snapshot was taken. |
| web_url_value | Optional[str] | Dashboard URL for viewing the balance. |
...
| Field | Type | Description |
|-------|------|-------------|
| transaction_id | str | Stripe ID of the balance transaction. |
| transaction_name | str | Display name of the transaction. |
| created_time | datetime | When the transaction was created. |
| web_url_value | Optional[str] | Dashboard URL for viewing the transaction. |
...
| charge_name | str | Display name of the charge. |
| created_time | datetime | When the charge was created. |
| updated_time | datetime | Last activity timestamp for the charge. |
| web_url_value | Optional[str] | Dashboard URL for the charge. |
...
| updated_time | datetime | Timestamp of the latest update. |
| web_url_value | Optional[str] | Dashboard URL for the customer. |
...
| event_name | str | Display name of the event. |
| created_time | datetime | When the event was created. |
| web_url_value | Optional[str] | Dashboard URL for the event. |
...
| payment_intent_name | str | Display name of the payment intent. |
| created_time | datetime | When the payment intent was created. |
| updated_time | datetime | Last update timestamp for the payment intent. |
| web_url_value | Optional[str] | Dashboard URL for the payment intent. |
...
| payment_method_name | str | Display name of the payment method. |
| created_time | datetime | When the payment method was created. |
| web_url_value | Optional[str] | Dashboard URL for the payment method. |
...
| Field | Type | Description |
|-------|------|-------------|
| payout_id | str | Stripe payout ID. |
| payout_name | str | Display name of the payout. |
| created_time | datetime | When the payout was created. |
| updated_time | datetime | Last update timestamp for the payout. |
| web_url_value | Optional[str] | Dashboard URL for the payout. |
...
| refund_name | str | Display name of the refund. |
| created_time | datetime | When the refund was created. |
| web_url_value | Optional[str] | Dashboard URL for the refund. |
...
| subscription_name | str | Display name of the subscription. |
| created_time | datetime | When the subscription was created. |
| updated_time | datetime | Last update timestamp for the subscription. |
| web_url_value | Optional[str] | Dashboard URL for the subscription. |
