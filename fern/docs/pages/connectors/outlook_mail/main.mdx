...
| web_url_override | Optional[str] | URL to open this folder in Outlook on the web. |
...
| web_url_override | Optional[str] | Link to the message in Outlook on the web. |
...
| Field | Type | Description |
|-------|------|-------------|
| composite_id | str | Composite attachment ID (message + attachment). |
...
| message_web_url | Optional[str] | URL to the parent message in Outlook on the web. |
