...
from airweave.core.protocols import AgenticSearchMetrics
...
async def agentic_search(
    ...
    metrics: AgenticSearchMetrics = Inject(AgenticSearchMetrics),
    ...
    try:
        ...
        agent = AgenticSearchAgent(services, ctx, emitter, metrics=metrics)
