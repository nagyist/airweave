...
from airweave.domains.embedders.mistral_dense import MistralDenseEmbedder
...
def _build_embedder(
    ...
    with (
        patch("airweave.domains.embedders.mistral_dense.Mistral") as mock_mistral_cls,
        patch(
            "airweave.domains.embedders.mistral_dense.get_tokenizer"
