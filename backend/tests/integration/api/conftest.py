...
# ---------------------------------------------------------------------------
# Fake ApiContext — minimal context that satisfies endpoint dependencies
# ---------------------------------------------------------------------------
...
def _make_fake_context() -> ApiContext:
    """Build a minimal ApiContext for API integration tests."""
...
async def client(test_container):
    ...
    Usage in tests:
        async def test_list_subscriptions(client, fake_webhook_admin):
