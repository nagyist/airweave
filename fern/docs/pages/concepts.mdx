...
To learn more about querying collections, including the three search tiers (instant, classic, agentic), retrieval strategies, and filtering, see the [Search](/search) documentation.
